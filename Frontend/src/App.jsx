...
import ThreatHeatmap from "./components/ThreatHeatmap.jsx";
...
import MobileAlerts from "./components/MobileAlerts.jsx";
      ...
      <div className="relative z-10">
        ...
        <main className="max-w-7xl mx-auto py-12 px-4 space-y-12">
          ...
          {currentPage === 'analytics' && (
            <div className="space-y-8">
              <AdvancedAnalytics detectionHistory={detectionHistory} />
